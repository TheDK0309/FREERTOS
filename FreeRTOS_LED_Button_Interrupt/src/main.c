...
static void prvSetupUart(void)
{
	...
	//enable the UART byte reception interrupt in the microcontroller
	USART_ITConfig(USART2,USART_IT_RXNE,ENABLE);

	//the priority in NVIC for the UART2 interrupt
...
void prvSetupGpio(void)
{
	...
	//system configuration for exti line (SYSCFG settings)
	SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOC,EXTI_PinSource13);

	//EXTI line configuration 13,falling edge, interrup mode
	...
	//NVIC settings (IRQ settings for the selected EXTI line(13)
