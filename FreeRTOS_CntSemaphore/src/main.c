...
static void prvSetupSoftwareInterrupt()
{
	//simulating the button interrupt by manually setting the interrupt enable bit in the NVIC enable register

	/*The ISR uses an (interrupt safe) FreeRTOS API
...
void EXTI15_10_IRQHandler( void )
{
	...
	//gives semaphore multiple times
